...
if(isset($_POST['update'])){
    ...
    $active = $_POST['active'];
    $id = $_POST['id'];
    if(!empty($full_name) && !empty($user_name) && !empty($email) && !empty($password) or !empty($active)){
        $query="UPDATE `users` SET `user_name`='$user_name',`full_name`='$full_name',`email`='$email',
        `password`='$password',`active`='$active' WHERE `user_id`='$id'";
        $sql = $dsn->prepare($query);
        $sql->execute();
