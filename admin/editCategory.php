...
$sql = $dsn->prepare("SELECT * FROM `categories` WHERE category_id='$id'");
$sql->execute();
$data = $sql->fetchAll();
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  method="POST" action="./updateCategory.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" name="editcategory" value="<?php foreach($data as $row){echo "{$row['category_name']}";}?>" class="form-control ">
