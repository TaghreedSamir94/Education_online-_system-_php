                      ...
                      <?php
                       foreach($data as $row){
                        ...
                        <tr>
                          ...
                          <td>{$row['title']}</td>
                          <td>{$row['active']}</td>
                          <td><a href='./editMeeting.php?id={$row['meeting_id']}'><img src='./images/edit.png' alt='Edit'></a></td>
                          <td><a href='./deleteMeeting.php?id={$row['meeting_id']}'><img src='./images/delete.png' alt='Delete'></a></td>
                        </tr>";}
                        ?>
