...
//for the name of the category to be viewed in the input form, the code is completed on line 273 - 281 - 288 - 295
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  method="POST" action="./updateMeeting.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="meeting-date" required="required" name="date" class="form-control" value="<?php foreach($data as $row){echo "{$row['meeting_date']}";} ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<input type="text" id="title" required="required" name="title" class="form-control" value="<?php foreach($data as $row){echo "{$row['title']}";} ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="instructor" required="required" name="ins_name" class="form-control" value="<?php foreach($data as $row){echo "{$row['instructor_name']}";} ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="description" required="required"  class="form-control" ><?php foreach($data as $row){echo "{$row['description']}";} ?></textarea>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" ><?php foreach($data as $row){echo "{$row['content']}";} ?></textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="location" class="col-form-label col-md-3 col-sm-3 label-align">Location <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="location" class="form-control" type="text" name="location" required="required" value="<?php foreach($data as $row){echo "{$row['locatin']}";} ?>" >
											</div>
										</div>
										<div class="item form-group">
											<label for="price" class="col-form-label col-md-3 col-sm-3 label-align">Price <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control" type="number" name="price" required="required" value="<?php foreach($data as $row){echo "{$row['price']}";} ?>">
											</div>
										</div>
										<div class="item form-group">
