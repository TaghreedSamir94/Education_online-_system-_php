...
(16, 'aaaaaaa', 'kjhgfdss', 'dfgj', '2024-02-22', 200.00, ' Breif Contents', 'Contents', 'Lydia-Violets024x585.jpg', 1, 13);
...
--
ALTER TABLE `meetings`
  MODIFY `meeting_id` int(50) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `user_id` int(50) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
